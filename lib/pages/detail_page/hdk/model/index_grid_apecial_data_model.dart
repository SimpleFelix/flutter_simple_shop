...
class IndexGridSpecialDataModel {
  ...
  factory IndexGridSpecialDataModel.fromJson(Map<String, dynamic> jsonRes) => IndexGridSpecialDataModel(
    bottomThree: BottomThree.fromJson(asT<Map<String, dynamic>>(jsonRes['bottomThree'])!),
...
class BottomThree {
  ...
  factory BottomThree.fromJson(Map<String, dynamic> jsonRes) {
    final List<GoodsInfo>? goods = jsonRes['goods'] is List ? <GoodsInfo>[] : null;
    if (goods != null) {
      for (final dynamic item in jsonRes['goods']) {
        if (item != null) {
          goods.add(GoodsInfo.fromJson(asT<Map<String, dynamic>>(item)!));
        }
      }
    }
...
class GoodsInfo {
  ...
  factory GoodsInfo.fromJson(Map<String, dynamic> jsonRes) => GoodsInfo(
...
class BottomFour {
  ...
  factory BottomFour.fromJson(Map<String, dynamic> jsonRes) {
...
class BottomOne {
  ...
  factory BottomOne.fromJson(Map<String, dynamic> jsonRes) {
...
class LeftTopOne {
  ...
  factory LeftTopOne.fromJson(Map<String, dynamic> jsonRes) {
    final List<GoodsInfo>? goods = jsonRes['goods'] is List ? <GoodsInfo>[] : null;
    if (goods != null) {
      for (final dynamic item in jsonRes['goods']) {
        if (item != null) {
...
class RightTopOne {
  ...
  factory RightTopOne.fromJson(Map<String, dynamic> jsonRes) {
    final List<GoodsInfo>? goods = jsonRes['goods'] is List ? <GoodsInfo>[] : null;
    if (goods != null) {
      for (final dynamic item in jsonRes['goods']) {
        if (item != null) {
...
class BottomTwo {
  ...
  factory BottomTwo.fromJson(Map<String, dynamic> jsonRes) {
    final List<GoodsInfo>? goods = jsonRes['goods'] is List ? <GoodsInfo>[] : null;
    if (goods != null) {
      for (final dynamic item in jsonRes['goods']) {
        if (item != null) {
