...
class _NewVersionPageState extends State<NewVersionPage> with LoadingMixin {
  ...
  Widget build(BuildContext context) {
    return EditePageHandle(
      child: Scaffold(
        appBar: SimpleAppBar(title: '上传新版本'),
        body: Padding(
            ...
            child: Column(
              children: [
                TextField(
                  ...
                  decoration: InputDecoration(hintText: '输入版本号'),
                ),
                TextField(controller: descController, decoration: InputDecoration(hintText: '输入版本更新内容')),
                TextField(controller: downUrlController, decoration: InputDecoration(hintText: '版本下载网址')),
                FancyElevatedButton(
                  onPressed: () async {
