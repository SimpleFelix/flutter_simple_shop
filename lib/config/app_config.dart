import 'package:demo1/pages/panic_buying/view.dart';
...
final List<IndexGridMenuItemModel> indexGridMenus = [
  IndexGridMenuItemModel(
      ...
      onTap: toPanicBuyPage,
      params: getToBrowserParams(
          'http://itbug.shop/index.php?r=activity/sc#/fengqianglist')),
  IndexGridMenuItemModel(
      '9.9包邮',
...
final List<IndexCarouselItemModel> indexCarouselsStateDatas = [
  IndexCarouselItemModel(
      ...
      imageUrl:
          'https://img.alicdn.com/imgextra/i2/2053469401/O1CN01zWvohl2JJhz8nII9X_!!2053469401.jpg',
      clickType: 'brower',
      params: '',
      intro: '一些备注,介绍'),
  IndexCarouselItemModel(
      title: '9块9爆品集',
      imageUrl:
          'https://img.alicdn.com/imgextra/i3/2053469401/O1CN01ZAZQnc2JJi3AT22Il_!!2053469401.jpg',
      clickType: 'brower',
      params: '',
      intro: '一些备注,介绍'),
  IndexCarouselItemModel(
      title: '为你倾心',
      imageUrl:
          'https://img.alicdn.com/imgextra/i4/2053469401/O1CN01u4PlHK2JJhzBsGH04_!!2053469401.jpg',
      clickType: 'brower',
      params: '',
      intro: '一些备注,介绍'),
  IndexCarouselItemModel(
      title: '休闲零食',
      imageUrl:
          'https://img.alicdn.com/imgextra/i4/2053469401/O1CN01sZei422JJi3BIqYCi_!!2053469401.jpg',
      clickType: 'brower',
      params: '',
      intro: '一些备注,介绍'),
  IndexCarouselItemModel(
      title: '全球尖货',
      imageUrl:
          'https://img.alicdn.com/imgextra/i1/2053469401/O1CN01oKK8D32JJi3C0Twb4_!!2053469401.jpg',
      clickType: 'brower',
      params: '',
      intro: '一些备注,介绍')
];
